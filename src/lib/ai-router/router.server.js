 ...
 */
export async function runZaplyAiTask(task, params) {
    ...
    try {
        ...
        if (message.includes("429"))
            throw new Error("Capacidade máxima atingida. Tente em breve.");
        if (message.includes("402"))
            throw new Error("Créditos insuficientes na plataforma.");
